...
t[#t + 1] = Def.ActorFrame {
	...
	{
		InitCommand = function(self)
			self:xy(frameX + 58, frameY + 48):zoom(0.6):halign(0.5):maxwidth(145):valign(1)
		end,
		MintyFreshCommand = function(self)
	...
	Def.BPMDisplay {
		...
		Name = "BPMDisplay",
		InitCommand = function(self)
			self:xy(capWideScale(get43size(384), 400) + 62, SCREEN_BOTTOM - 111):halign(1):zoom(0.50)
		end,
	...
	LoadFont("Common Large") ..
	{
		...
		InitCommand = function(self)
			self:xy((capWideScale(get43size(384), 400)) + 62, SCREEN_BOTTOM - 91):visible(true):halign(1):zoom(
...
t[#t + 1] =
	...
	{
		InitCommand = function(self)
			self:xy(capWideScale(get43size(379), 395) + 41, SCREEN_BOTTOM - 111):halign(1):zoom(0.50)
		end,
		MortyFartsCommand = function(self)
			if song then
